...
public class fragment_hoa_don_chua_thanh_toan extends Fragment {

    RecyclerView rcv_hoa_don_chua_thanh_toan;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_hoa_don_chua_thanh_toan, container, false);

        rcv_hoa_don_chua_thanh_toan = view.findViewById(R.id.rcv_hoa_don_chua_thanh_toan);
        ...
        rcv_hoa_don_chua_thanh_toan.setLayoutManager(linearLayoutManager);
        ds_cthd = new ArrayList<>();

        adapterHoaDonChuaThanhToan = new Adapter_hoa_don_chua_thanh_toan(getActivity(), ds_cthd);


        rcv_hoa_don_chua_thanh_toan.setAdapter(adapterHoaDonChuaThanhToan);
    ...
    private void getHoaDon() {
        ...
        db.collection("QuanLiHoaDon") //Lấy dữ liệu từ Firestore collection có tên "HomeProduct".
                .whereEqualTo("trangThai", "Chưa thanh toán")
                .get()
